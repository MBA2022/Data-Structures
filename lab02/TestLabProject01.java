...
public class TestLabProject01{
   public static void main(String[] args){
	 ...
	 MySearchableContainer ics202Container = new MySearchableContainer();
	...
	ics202Container.insert(instructor1SectionAssociation);
	ics202Container.insert(instructor2SectionAssociation);
